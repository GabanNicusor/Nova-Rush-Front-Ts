...
const SuccessDeliveryCard: React.FC<SuccessDeliveryCardProps> = ({
  onPress,
}) => {
  return (
    <View style={styles.card as StyleProp<ViewStyle>}>
      {/* SuccessDeliveryIcon is assumed to be an SVG component that accepts the onPress handler */}
...
export default SuccessDeliveryCard;
