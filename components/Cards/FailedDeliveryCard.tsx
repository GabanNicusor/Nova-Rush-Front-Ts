...
const FailedDeliveryCard: React.FC<FailedDeliveryCardProps> = ({ onPress }) => {
  return (
    <View style={styles.card as StyleProp<ViewStyle>}>
      {/* FailedDeliveryIcon is assumed to be an SVG component that accepts the onPress handler */}
      <FailedDeliveryIcon onPress={onPress} />
      <Text style={{ textAlign: 'center', left: -3 } as StyleProp<TextStyle>}>
        Failed
      </Text>
    </View>
  );
};
export default FailedDeliveryCard;
